...
## demo("sec3.1_ex1", package = "MixSim")
set.seed(1234)
(ex.1 <- MixSim(BarOmega = 0.05, MaxOmega = 0.15, K = 4, p = 5))
summary(ex.1)


## Example 2 from Section 3.1
## demo("sec3.1_ex2", package = "MixSim")
set.seed(1234)
(ex.2 <- MixSim(MaxOmega = 0.1, K = 3, p = 2, sph = TRUE, PiLow = 0.1))
summary(ex.2)

## Example 3 from Section 3.1
## demo("sec3.1_ex3", package = "MixSim")
set.seed(1234)
...
## demo("sec3.2_ex1", package = "MixSim")
...
## Figure 1a,b from Section 3.3
## demo("sec3.3_ex1a", package = "MixSim")
set.seed(1234)
...
## demo("sec3.3_ex1b", package = "MixSim")
set.seed(1235)
Q <- MixSim(MaxOmega = 0.20, BarOmega = 0.05, K = 5, p = 2)
A <- simdataset(n = 500, Pi = Q$Pi, Mu = Q$Mu, S = Q$S)
colors <- c("red", "green", "blue", "brown", "magenta")
...
## Figure 1c,d from Section 3.3
## demo("sec3.3_ex2c", package = "MixSim")
set.seed(1238)
...
## demo("sec3.3_ex2d", package = "MixSim")
set.seed(1238)
Q <- MixSim(MaxOmega = 0.1, K = 3, p = 2, int = c(0.2, 1))
...
## Figure 2a,b from Section 3.3
## demo("sec3.3_ex3a", package = "MixSim")
set.seed(1234)
...
## demo("sec3.3_ex3b", package = "MixSim")
set.seed(1237)
Q <- MixSim(BarOmega = 0.01, K = 4, p = 2)
A <- simdataset(n = 500, Pi = Q$Pi, Mu = Q$Mu, S = Q$S, n.out = 10)
colors <- c("red", "green", "blue", "brown", "magenta")
...
## Figure 2c,d from Section 3.3
## demo("sec3.3_ex4c", package = "MixSim")
set.seed(1235)
...
## demo("sec3.3_ex4d", package = "MixSim")
set.seed(1236)
Q <- MixSim(MaxOmega = 0.1, K = 4, p = 1)
A <- simdataset(n = 300, Pi = Q$Pi, Mu = Q$Mu, S = Q$S, n.noise = 1)
colors <- c("red", "green", "blue", "brown")
...
## Figure 3a from Section 3.4
## demo("sec3.4_ex1", package = "MixSim")
data("iris", package = "datasets")
p <- ncol(iris) - 1
id <- as.integer(iris[, 5])
K <- max(id)
...
## Figure 3b,c from Section 3.4
## demo("sec3.4_ex2b", package = "MixSim")
set.seed(1234)
Q <- MixSim(BarOmega = 0.001, K = 6, p = 4)
pdplot(Pi = Q$Pi, Mu = Q$Mu, S = Q$S)

## demo("sec3.4_ex2c", package = "MixSim")
set.seed(1232)
...
id1 <- c(1, 1, 1, 1, 2, 2, 2, 3, 3, 3)
id2 <- c(1, 1, 1, 2, 2, 2, 3, 2, 3, 3)
RandIndex(id1, id2)
ClassProp(id1, id2)
VarInf(id1, id2)
...
## Experiment from Section 4
## demo("sec4_ex1", package = "MixSim")
library("mclust")
library("cluster")
