...
library("ppclust")
library("fclust")
setwd("F:/TG2/results/simul_mixsim")
...
#        proportion and information variance
    ...
    iter <-0
    for (minpts in seq(1, 25, 5)){
      for (eps in seq(0, 0.3, .1)){
